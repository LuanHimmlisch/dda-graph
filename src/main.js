...
k.loadMusic('bg', '/music/background.wav');
k.loadSound('explosion-1', '/sounds/explosion-1.wav');
k.loadSound('explosion-2', '/sounds/explosion-2.wav');
k.loadSound('explosion-3', '/sounds/explosion-3.wav');
k.loadSound('explosion-4', '/sounds/explosion-4.wav');
...
k.loadSprite("sun", "sprites/sun-o.png");
...
function checkInitialFocus() {
    ...
    k.play('bg', { volume: 0.2, loop: true });
}

canAutoplay.audio().then(({ result }) => result && checkInitialFocus());
